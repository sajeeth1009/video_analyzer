...
def yolo_recommendations(video_file, video_request):
    ...
    # try to determine the total number of frames in the video fileif imutils.is_cv2() \cv2.cv.CV_CAP_PROP_FRAME_COUNT
    ...
    while True:
        ...
        if writer is None:
            ...
            writer = cv2.VideoWriter('assets/out.mp4', fourcc, 30,
